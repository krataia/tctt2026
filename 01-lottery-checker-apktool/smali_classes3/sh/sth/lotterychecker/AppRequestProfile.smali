.class public final Lsh/sth/lotterychecker/AppRequestProfile;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lsh/sth/lotterychecker/AppRequestProfile;",
        "",
        "()V",
        "APP_ID",
        "",
...
# static fields
.field public static final APP_ID:Ljava/lang/String; = "sh.sth.lotterychecker"
...
.field public static final INSTANCE:Lsh/sth/lotterychecker/AppRequestProfile;

.field private static final PREFS:Ljava/lang/String; = "request_profile"

.field public static final USER_AGENT:Ljava/lang/String; = "THCTT-Mobile01/1 (Android; sh.sth.lotterychecker)"
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lsh/sth/lotterychecker/AppRequestProfile;

    invoke-direct {v0}, Lsh/sth/lotterychecker/AppRequestProfile;-><init>()V

    sput-object v0, Lsh/sth/lotterychecker/AppRequestProfile;->INSTANCE:Lsh/sth/lotterychecker/AppRequestProfile;
    ...
    sput-object v0, Lsh/sth/lotterychecker/AppRequestProfile;->random:Ljava/security/SecureRandom;
    ...
    sput-object v0, Lsh/sth/lotterychecker/AppRequestProfile;->installPattern:Lkotlin/text/Regex;
...
.method private final isCanonicalInstallId(Ljava/lang/String;)Z
    ...
    .line 33
    sget-object v0, Lsh/sth/lotterychecker/AppRequestProfile;->installPattern:Lkotlin/text/Regex;
    ...
    check-cast v0, Lsh/sth/lotterychecker/AppRequestProfile;

    .local v0, "$this$isCanonicalInstallId_u24lambda_u244":Lsh/sth/lotterychecker/AppRequestProfile;
    const/4 v2, 0x0
    ...
    .end local v0    # "$this$isCanonicalInstallId_u24lambda_u244":Lsh/sth/lotterychecker/AppRequestProfile;
...
.method public final apply(Ljava/net/HttpURLConnection;Landroid/content/Context;)V
    ...
    const-string v1, "THCTT-Mobile01/1 (Android; sh.sth.lotterychecker)"
    ...
    const-string v1, "sh.sth.lotterychecker"
    ...
    invoke-virtual {p0, p2}, Lsh/sth/lotterychecker/AppRequestProfile;->installId(Landroid/content/Context;)Ljava/lang/String;
...
.method public final declared-synchronized installId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, v4}, Lsh/sth/lotterychecker/AppRequestProfile;->isCanonicalInstallId(Ljava/lang/String;)Z
    ...
    .end local p0    # "this":Lsh/sth/lotterychecker/AppRequestProfile;
    :cond_1
    const/16 v2, 0x10
    ...
    sget-object v3, Lsh/sth/lotterychecker/AppRequestProfile;->random:Ljava/security/SecureRandom;
