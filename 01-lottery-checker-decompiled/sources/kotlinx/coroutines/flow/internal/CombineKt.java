        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    holder = resultChannel.mo1665receiveCatchingJP2dKIU(anonymousClass2);
                    if (holder == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    latestValues2 = latestValues;
                    element = (IndexedValue) ChannelResult.m1677getOrNullimpl(holder);
                    if (element != null) {
                        return Unit.INSTANCE;
                    }
                    do {
                        ...
                        if (lastReceivedEpoch[index] != remainingAbsentValues) {
                            ...
                            element = (IndexedValue) ChannelResult.m1677getOrNullimpl(resultChannel.mo1666tryReceivePtdJZtk());
                        }
