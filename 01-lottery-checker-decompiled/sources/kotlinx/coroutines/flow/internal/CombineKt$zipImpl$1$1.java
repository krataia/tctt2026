                ...
                public final Object invokeSuspend(Object obj) throws Throwable {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            c00081 = this;
                            c00081.label = 1;
                            objMo1665receiveCatchingJP2dKIU = c00081.$second.mo1665receiveCatchingJP2dKIU(c00081);
                            if (objMo1665receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            FlowCollector flowCollector = c00081.$this_unsafeFlow;
                            if (!(objMo1665receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                                Throwable thM1676exceptionOrNullimpl = ChannelResult.m1676exceptionOrNullimpl(objMo1665receiveCatchingJP2dKIU);
                                if (thM1676exceptionOrNullimpl == null) {
                                    throw new AbortFlowException(flowCollector);
                                }
                                throw thM1676exceptionOrNullimpl;
                            }
                            Object obj3 = c00081.$this_unsafeFlow;
                            Function3 function3 = c00081.$transform;
                            Object obj4 = c00081.$value;
                            if (objMo1665receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                objMo1665receiveCatchingJP2dKIU = null;
                            }
                            c00081.L$0 = obj3;
                            c00081.label = 2;
                            Object objInvoke = function3.invoke(obj4, objMo1665receiveCatchingJP2dKIU, c00081);
                        ...
                        case 1:
                            c00081 = this;
                            ResultKt.throwOnFailure(obj);
                            objMo1665receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            ...
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                switch (combineKt$zipImpl$1$1$2$1$emit$12.label) {
                    case 0:
                        ...
                        if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj, c00081, combineKt$zipImpl$1$1$2$1$emit$12) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                    case 1:
