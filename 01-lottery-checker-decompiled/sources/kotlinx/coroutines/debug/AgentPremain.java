...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM161constructorimpl = Result.m161constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM161constructorimpl = Result.m161constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m167isFailureimpl(objM161constructorimpl) ? null : objM161constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1690installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1690installSignalHandler$lambda1(Signal it) {
