...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM161constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM161constructorimpl = Result.m161constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM161constructorimpl = Result.m161constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m164exceptionOrNullimpl(objM161constructorimpl) == null) {
            obj2 = objM161constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM161constructorimpl2 = Result.m161constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM161constructorimpl2 = Result.m161constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m164exceptionOrNullimpl(objM161constructorimpl2) == null) {
            obj = objM161constructorimpl2;
        }
