...
public interface SendChannel<E> {
    ...
    Object mo1667trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1667trySendJP2dKIU(e);
            if (ChannelResult.m1682isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1676exceptionOrNullimpl = ChannelResult.m1676exceptionOrNullimpl(result);
