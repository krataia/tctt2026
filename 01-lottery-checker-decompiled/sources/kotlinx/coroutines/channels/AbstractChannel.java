...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1665receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        switch (abstractChannel$receiveCatching$12.label) {
            case 0:
                ...
                if (result != AbstractChannelKt.POLL_FAILED) {
                    return result instanceof Closed ? ChannelResult.INSTANCE.m1685closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1687successJP2dKIU(result);
                }
    ...
    public final Object mo1666tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1686failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1685closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1687successJP2dKIU(result);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1704constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1712remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1709plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1664onCancelIdempotentListww6eGU(list, closedForSend);
                return;
            }
        }
    }
    ...
    protected void mo1664onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) throws Throwable {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1672boximpl(ChannelResult.INSTANCE.m1685closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1672boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1685closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1687successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m161constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cont.resumeWith(Result.m161constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1672boximpl(ChannelResult.INSTANCE.m1687successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m161constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                ChannelResult channelResultM1672boximpl = ChannelResult.m1672boximpl(ChannelResult.INSTANCE.m1685closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m161constructorimpl(channelResultM1672boximpl));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1672boximpl(ChannelResult.INSTANCE.m1687successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        break;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1672boximpl(ChannelResult.INSTANCE.m1685closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        break;
                }
            }
        }
