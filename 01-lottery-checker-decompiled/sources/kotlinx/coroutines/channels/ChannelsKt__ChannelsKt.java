...
final /* synthetic */ class ChannelsKt__ChannelsKt {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        r = Result.m161constructorimpl(ResultKt.createFailure(th));
                    }
                    if (sendChannel.send(e, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    r = Result.m161constructorimpl(Unit.INSTANCE);
                    return ChannelResult.m1672boximpl(!Result.m168isSuccessimpl(r) ? ChannelResult.INSTANCE.m1687successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1685closedJP2dKIU(Result.m164exceptionOrNullimpl(r)));
                case 1:
                    try {
                        ResultKt.throwOnFailure($result);
                        r = Result.m161constructorimpl(Unit.INSTANCE);
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo1667trySendJP2dKIU(e);
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1682isSuccessimpl(sendChannel.mo1667trySendJP2dKIU(e))) {
