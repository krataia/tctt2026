...
public interface ReceiveChannel<E> {
    ...
    Object mo1665receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1666tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1666tryReceivePtdJZtk = receiveChannel.mo1666tryReceivePtdJZtk();
            if (ChannelResult.m1682isSuccessimpl(objMo1666tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1678getOrThrowimpl(objMo1666tryReceivePtdJZtk);
            }
            Throwable thM1676exceptionOrNullimpl = ChannelResult.m1676exceptionOrNullimpl(objMo1666tryReceivePtdJZtk);
            if (thM1676exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1676exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            Object objMo1665receiveCatchingJP2dKIU;
            ...
            switch (anonymousClass12.label) {
                case 0:
                    ...
                    objMo1665receiveCatchingJP2dKIU = receiveChannel.mo1665receiveCatchingJP2dKIU(anonymousClass12);
                    if (objMo1665receiveCatchingJP2dKIU == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1665receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1677getOrNullimpl(objMo1665receiveCatchingJP2dKIU);
        }
