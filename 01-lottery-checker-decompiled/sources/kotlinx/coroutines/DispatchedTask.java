...
public abstract class DispatchedTask<T> extends Task {
    ...
    */
    public final void run() {
                    ...
                    try {
                        ...
                        try {
                            if (job == null && !job.isActive()) {
                                ...
                                if (DebugKt.getRECOVER_STACK_TRACES()) {
                                    try {
                                        if (continuation instanceof CoroutineStackFrame) {
                                            ...
                                            continuation.resumeWith(Result.m161constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                                        }
                                    } catch (Throwable th) {
                                        th = th;
                                ...
                                continuation.resumeWith(Result.m161constructorimpl(ResultKt.createFailure(exception)));
                            } else {
                                Result.Companion companion3 = Result.INSTANCE;
                                continuation.resumeWith(Result.m161constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                            }
                            ...
                            try {
                                ...
                                result = Result.m161constructorimpl(Unit.INSTANCE);
                            } catch (Throwable th2) {
                                th = th2;
                                Result.Companion companion5 = Result.INSTANCE;
                                result = Result.m161constructorimpl(ResultKt.createFailure(th));
                            }
                        } catch (Throwable th3) {
                            th = th3;
                        }
        ...
        handleFatalException(fatalException, Result.m164exceptionOrNullimpl(result));
    }
