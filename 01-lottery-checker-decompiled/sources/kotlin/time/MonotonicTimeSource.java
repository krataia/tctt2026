...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1627boximpl(m1621markNowz9LOYto());
    }
    ...
    public long m1621markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1630constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1620elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1619differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m1618adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1630constructorimpl(LongSaturatedMathKt.m1616saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
