...
public final class DurationKt {
    ...
    private static final long m1614timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1525timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1613timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1524timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:183:0x00dd A[EDGE_INSN: B:183:0x00dd->B:52:0x00dd BREAK  A[LOOP:1: B:39:0x0083->B:50:0x00c2], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:50:0x00c2 A[LOOP:1: B:39:0x0083->B:50:0x00c2, LOOP_END] */
    /*
    ...
    */
    public static final long parseDuration(String value, boolean strictIso) {
        ...
        long result = Duration.INSTANCE.m1590getZEROUwyO8pc();
        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index2 < length) {
                if (value.charAt(index2) == 'T') {
                    ...
                    if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                        ...
                        long result2 = Duration.m1523plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(whole), unit));
                        Intrinsics.checkNotNull(component, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring = component.substring(dotIndex);
                        Intrinsics.checkNotNullExpressionValue(strSubstring, "substring(...)");
                        result = Duration.m1523plusLRDsOJo(result2, toDuration(Double.parseDouble(strSubstring), unit));
                        nonDigitSymbols2 = nonDigitSymbols;
                        infinityString2 = infinityString;
                        isNegative3 = isNegative2;
                        hasSign2 = hasSign;
                    } else {
                        result = Duration.m1523plusLRDsOJo(result, toDuration(parseOverLongIsoComponent(component), unit));
                        nonDigitSymbols2 = nonDigitSymbols;
                        infinityString2 = infinityString;
                        isNegative3 = isNegative2;
                        hasSign2 = hasSign;
            ...
            if (!strictIso) {
                ...
                if (StringsKt.regionMatches(value, index, "Infinity", 0, Math.max(length - index, "Infinity".length()), true)) {
                    result = Duration.INSTANCE.m1588getINFINITEUwyO8pc();
                } else {
                    ...
                    while (index < length) {
                        ...
                        if (dotIndex2 > 0) {
                            ...
                            String str3 = str2;
                            long result3 = Duration.m1523plusLRDsOJo(result, toDuration(Long.parseLong(whole2), unit2));
                            Intrinsics.checkNotNull(component2, "null cannot be cast to non-null type java.lang.String");
                            String strSubstring2 = component2.substring(dotIndex2);
                            Intrinsics.checkNotNullExpressionValue(strSubstring2, "substring(...)");
                            result = Duration.m1523plusLRDsOJo(result3, toDuration(Double.parseDouble(strSubstring2), unit2));
                            if (index < length) {
                            ...
                            result = Duration.m1523plusLRDsOJo(result, toDuration(Long.parseLong(component2), unit2));
                            str2 = str2;
                            afterFirst2 = afterFirst;
                            allowSpaces2 = allowSpaces;
                        }
        ...
        return isNegative ? Duration.m1540unaryMinusUwyO8pc(result) : result;
    }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1487constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1487constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1487constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
