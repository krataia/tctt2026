...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] result = UByteArray.m231constructorimpl(collection.size());
        int index = 0;
        Iterator<UByte> it = collection.iterator();
        while (it.hasNext()) {
            byte element = it.next().getData();
            UByteArray.m242setVurrAj0(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] result = UIntArray.m310constructorimpl(collection.size());
        int index = 0;
        Iterator<UInt> it = collection.iterator();
        while (it.hasNext()) {
            int element = it.next().getData();
            UIntArray.m321setVXSXFK8(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] result = ULongArray.m389constructorimpl(collection.size());
        int index = 0;
        Iterator<ULong> it = collection.iterator();
        while (it.hasNext()) {
            long element = it.next().getData();
            ULongArray.m400setk8EXiF4(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] result = UShortArray.m494constructorimpl(collection.size());
        int index = 0;
        Iterator<UShort> it = collection.iterator();
        while (it.hasNext()) {
            short element = it.next().getData();
            UShortArray.m505set01HTLdE(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        while (it.hasNext()) {
            int element = it.next().getData();
            sum = UInt.m256constructorimpl(sum + element);
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        while (it.hasNext()) {
            long element = it.next().getData();
            sum = ULong.m335constructorimpl(sum + element);
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        while (it.hasNext()) {
            byte element = it.next().getData();
            sum = UInt.m256constructorimpl(UInt.m256constructorimpl(element & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        while (it.hasNext()) {
            short element = it.next().getData();
            sum = UInt.m256constructorimpl(UInt.m256constructorimpl(65535 & element) + sum);
        }
        return sum;
    }
}
