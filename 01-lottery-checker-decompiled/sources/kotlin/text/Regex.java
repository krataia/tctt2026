        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00661 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00661.L$0;
                    matcher = Regex.this.nativePattern.matcher(c00661.$input);
                    if (c00661.$limit == 1 || !matcher.find()) {
                        c00661.label = 1;
                        return $this$sequence2.yield(c00661.$input.toString(), c00661) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c00661.L$0 = $this$sequence;
                    c00661.L$1 = matcher;
                    c00661.I$0 = splitCount;
                    c00661.label = 2;
                    if ($this$sequence.yield(c00661.$input.subSequence(nextStart, matcher.start()).toString(), c00661) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00661.$limit - 1 || !matcher.find()) {
                        c00661.L$0 = null;
                        c00661.L$1 = null;
                        c00661.label = 3;
                        return $this$sequence.yield(c00661.$input.subSequence(nextStart, c00661.$input.length()).toString(), c00661) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    c00661.L$0 = $this$sequence;
                    c00661.L$1 = matcher;
                    c00661.I$0 = splitCount;
                    ...
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00661.$limit - 1) {
                    }
                    c00661.L$0 = null;
                    c00661.L$1 = null;
                    c00661.label = 3;
                    if ($this$sequence.yield(c00661.$input.subSequence(nextStart, c00661.$input.length()).toString(), c00661) == coroutine_suspended) {
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                case 2:
                    c00661 = this;
                    splitCount = c00661.I$0;
                    matcher = (Matcher) c00661.L$1;
                    $this$sequence = (SequenceScope) c00661.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00661.$limit - 1) {
