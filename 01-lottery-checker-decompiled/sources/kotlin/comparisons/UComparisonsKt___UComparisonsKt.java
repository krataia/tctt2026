...
public class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m1345maxOfMd2H83M(int a, int... other) {
        ...
        int max = a;
        int iM317getSizeimpl = UIntArray.m317getSizeimpl(other);
        for (int i = 0; i < iM317getSizeimpl; i++) {
            int e = UIntArray.m316getpVg5ArA(other, i);
    ...
    public static final long m1346maxOfR03FKyM(long a, long... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        long max = a;
        int iM396getSizeimpl = ULongArray.m396getSizeimpl(other);
        for (int i = 0; i < iM396getSizeimpl; i++) {
            long e = ULongArray.m395getsVKNKU(other, i);
    ...
    public static final byte m1349maxOfWr6uiD8(byte a, byte... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        byte max = a;
        int iM238getSizeimpl = UByteArray.m238getSizeimpl(other);
        for (int i = 0; i < iM238getSizeimpl; i++) {
            byte e = UByteArray.m237getw2LRezQ(other, i);
    ...
    public static final short m1353maxOft1qELG4(short a, short... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        short max = a;
        int iM501getSizeimpl = UShortArray.m501getSizeimpl(other);
        for (int i = 0; i < iM501getSizeimpl; i++) {
            short e = UShortArray.m500getMh2AYeg(other, i);
