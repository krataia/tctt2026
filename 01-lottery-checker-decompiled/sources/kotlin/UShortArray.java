...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UShort) {
            return m508containsxj2QHRw(((UShort) element).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m494constructorimpl(int size) {
        return m495constructorimpl(new short[size]);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m500getMh2AYeg(short[] arg0, int index) {
        return UShort.m442constructorimpl(arg0[index]);
    }

    /* JADX INFO: renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m505set01HTLdE(short[] arg0, int index, short value) {
        arg0[index] = value;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m501getSizeimpl(short[] arg0) {
        return arg0.length;
    }
    ...
    public static java.util.Iterator<UShort> m504iteratorimpl(short[] arg0) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m436boximpl(m510nextMh2AYeg());
        }
        ...
        public short m510nextMh2AYeg() {
            ...
            int i = this.index;
            this.index = i + 1;
            return UShort.m442constructorimpl(sArr[i]);
        }
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m508containsxj2QHRw(short element) {
        return m496containsxj2QHRw(this.storage, element);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m496containsxj2QHRw(short[] arg0, short element) {
    ...
    public static boolean m497containsAllimpl(short[] arg0, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m503isEmptyimpl(short[] arg0) {
