...
public class ConstraintWidget {
    ...
    /* JADX WARN: Type inference failed for: r73v0, types: [androidx.constraintlayout.core.widgets.ConstraintWidget] */
    ...
    /* JADX WARN: Type inference failed for: r7v4, types: [androidx.constraintlayout.core.widgets.ConstraintWidget] */
    /* JADX WARN: Type inference failed for: r7v5, types: [androidx.constraintlayout.core.widgets.ConstraintWidget] */
    /* JADX WARN: Type inference failed for: r8v18 */
    /* JADX WARN: Type inference failed for: r8v6 */
    /* JADX WARN: Type inference failed for: r8v7, types: [androidx.constraintlayout.core.LinearSystem] */
    /*
    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.mParent == null) {
            ...
            boolean z13 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            boolean z14 = this.mParent != null && this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            ...
            if (this.resolvedHorizontal) {
                ...
                if (z2 && this.mParent != null) {
                    if (this.OPTIMIZE_WRAP_ON_RESOLVED) {
                        ...
                        linearSystem.addGreaterThan(linearSystem.createObjectVariable(this.mParent.mRight), solverVariableCreateObjectVariable2, 0, 5);
                    }
                }
            }
            if (this.resolvedVertical) {
                ...
                if (z3 && this.mParent != null) {
                    if (this.OPTIMIZE_WRAP_ON_RESOLVED) {
                        ConstraintWidgetContainer constraintWidgetContainer2 = (ConstraintWidgetContainer) this.mParent;
                        ...
                        linearSystem.addGreaterThan(linearSystem.createObjectVariable(this.mParent.mBottom), solverVariableCreateObjectVariable4, 0, 5);
                    }
                }
            }
            if (this.resolvedHorizontal && this.resolvedVertical) {
        ...
        if (z && this.horizontalRun != null && this.verticalRun != null && this.horizontalRun.start.resolved && this.horizontalRun.end.resolved && this.verticalRun.start.resolved && this.verticalRun.end.resolved) {
            if (LinearSystem.sMetrics != null) {
        ...
        if (this.mDimensionRatio <= 0.0f || this.mVisibility == 8) {
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i12 == 3 && i13 == 3) {
                setupDimensionRatio(z2, z3, z15, z16);
            } else if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && i12 == 3) {
            ...
            } else if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i13 == 3) {
                this.mResolvedDimensionRatioSide = 1;
                if (this.mDimensionRatioSide == -1) {
                    this.mResolvedDimensionRatio = 1.0f / this.mResolvedDimensionRatio;
                }
                int i16 = (int) (this.mResolvedDimensionRatio * this.mWidth);
                if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                    i4 = i16;
                    i = i13;
                    i2 = i12;
        ...
        boolean z17 = z6 && (this.mResolvedDimensionRatioSide == 0 || this.mResolvedDimensionRatioSide == -1);
        boolean z18 = z6 && (this.mResolvedDimensionRatioSide == 1 || this.mResolvedDimensionRatioSide == -1);
        ...
        boolean z20 = this.mIsInBarrier[0];
        boolean z21 = this.mIsInBarrier[1];
        if (this.mHorizontalResolution == 2 || this.resolvedHorizontal) {
        ...
        } else if (!z || this.horizontalRun == null || !this.horizontalRun.start.resolved || !this.horizontalRun.end.resolved) {
            char c = '\b';
            SolverVariable solverVariableCreateObjectVariable6 = this.mParent != null ? linearSystem.createObjectVariable(this.mParent.mRight) : null;
            z8 = z3;
            z9 = z2;
            z10 = z6;
            solverVariable = solverVariableCreateObjectVariable5;
            ...
            solverVariable4 = solverVariableCreateObjectVariable2;
            solverVariable5 = solverVariableCreateObjectVariable;
            applyConstraints(linearSystem, true, z2, z8, this.isTerminalWidget[0], this.mParent != null ? linearSystem.createObjectVariable(this.mParent.mLeft) : null, solverVariableCreateObjectVariable6, this.mListDimensionBehaviors[0], z19, this.mLeft, this.mRight, this.mX, i5, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z17, this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT, z4, z5, z20, i2, i, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z7);
        } else if (z) {
            linearSystem.addEquality(solverVariableCreateObjectVariable, this.horizontalRun.start.value);
            linearSystem.addEquality(solverVariableCreateObjectVariable2, this.horizontalRun.end.value);
        ...
        if (!z) {
            ...
            ?? r73 = this;
            VerticalWidgetRun verticalWidgetRun = r73.verticalRun;
            r7 = r73;
            if (verticalWidgetRun != null) {
                boolean z23 = r73.verticalRun.start.resolved;
                r7 = r73;
                if (z23) {
                    boolean z24 = r73.verticalRun.end.resolved;
                    r7 = r73;
                    if (z24) {
                        LinearSystem linearSystem2 = linearSystem;
                        solverVariable8 = solverVariable3;
                        linearSystem2.addEquality(solverVariable8, r73.verticalRun.start.value);
                        solverVariable7 = solverVariable2;
                        linearSystem2.addEquality(solverVariable7, r73.verticalRun.end.value);
                        solverVariable6 = solverVariable;
                        linearSystem2.addEquality(solverVariable6, r73.verticalRun.baseline.value);
                        if (r73.mParent == null) {
                            i6 = 1;
                            i7 = 8;
                            i8 = 0;
                            ...
                            if (z5 || !z8) {
                                ...
                                i6 = 1;
                                if (r73.isTerminalWidget[1]) {
                                    i7 = 8;
                                    i8 = 0;
                                    linearSystem2.addGreaterThan(linearSystem2.createObjectVariable(r73.mParent.mBottom), solverVariable7, 0, 8);
                                }
                            }
                            i7 = 8;
                            i8 = 0;
            ...
            if (r72.mVerticalResolution == 2) {
                z11 = z22;
            } else {
                z11 = false;
            }
            if (!z11 && !r72.resolvedVertical) {
                int i17 = (r72.mListDimensionBehaviors[i6] == DimensionBehaviour.WRAP_CONTENT && (r72 instanceof ConstraintWidgetContainer)) ? i6 : i8;
                if (i17 == 0) {
                    i9 = i4;
                } else {
                    i9 = 0;
                }
                SolverVariable solverVariableCreateObjectVariable7 = r72.mParent != null ? r8.createObjectVariable(r72.mParent.mBottom) : null;
                SolverVariable solverVariableCreateObjectVariable8 = r72.mParent != null ? r8.createObjectVariable(r72.mParent.mTop) : null;
                if (r72.mBaselineDistance > 0 || r72.mVisibility == i7) {
                    if (r72.mBaseline.mTarget != null) {
                        r8.addEquality(solverVariable6, solverVariable8, getBaselineDistance(), i7);
                        r8.addEquality(solverVariable6, r8.createObjectVariable(r72.mBaseline.mTarget), r72.mBaseline.getMargin(), i7);
                        if (z8) {
                            r8.addGreaterThan(solverVariableCreateObjectVariable7, r8.createObjectVariable(r72.mBottom), i8, 5);
                        }
                        z12 = false;
                        applyConstraints(linearSystem, false, z8, z9, r72.isTerminalWidget[i6], solverVariableCreateObjectVariable8, solverVariableCreateObjectVariable7, r72.mListDimensionBehaviors[i6], i17, r72.mTop, r72.mBottom, r72.mY, i9, r72.mMinHeight, r72.mMaxDimension[i6], r72.mVerticalBiasPercent, z18, r72.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT, z5, z4, z21, i, i2, r72.mMatchConstraintMinHeight, r72.mMatchConstraintMaxHeight, r72.mMatchConstraintPercentHeight, z12);
                    } else {
                        if (r72.mVisibility == i7) {
                            r8.addEquality(solverVariable6, solverVariable8, r72.mBaseline.getMargin(), i7);
                        } else {
                            r8.addEquality(solverVariable6, solverVariable8, getBaselineDistance(), i7);
                        }
                        z12 = z7;
            ...
            if (z10) {
                if (r72.mResolvedDimensionRatioSide == 1) {
                    linearSystem.addRatio(solverVariable7, solverVariable8, solverVariable4, solverVariable5, r72.mResolvedDimensionRatio, 8);
                } else {
                    linearSystem.addRatio(solverVariable4, solverVariable5, solverVariable7, solverVariable8, r72.mResolvedDimensionRatio, 8);
                }
            }
            if (r72.mCenter.isConnected()) {
                r8.addCenterPoint(r72, r72.mCenter.getTarget().getOwner(), (float) Math.toRadians(r72.mCircleConstraintAngle + 90.0f), r72.mCenter.getMargin());
            }
            r72.resolvedHorizontal = false;
            r72.resolvedVertical = false;
        }
        r8 = linearSystem;
        solverVariable6 = solverVariable;
        solverVariable7 = solverVariable2;
    ...
    */
    private void applyConstraints(LinearSystem system, boolean isHorizontal, boolean parentWrapContent, boolean oppositeParentWrapContent, boolean isTerminal, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean oppositeVariable, boolean inChain, boolean oppositeInChain, boolean inBarrier, int matchConstraintDefault, int oppositeMatchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        SolverVariable end3 = system.createObjectVariable(endAnchor);
        ...
        boolean variableSize4 = variableSize3;
        ...
        if (applyPosition) {
            if (!isBeginConnected && !isEndConnected && !isCenterConnected) {
                ...
                system.addEquality(begin3, beginTarget3, beginAnchor.getMargin(), 8);
            }
        }
        if (!variableSize2) {
            if (wrapContent) {
                system.addEquality(end3, begin3, 0, 3);
                if (minDimension > 0) {
                    i = 8;
                    system.addGreaterThan(end3, begin3, minDimension, 8);
                } else {
                    i = 8;
                }
                if (maxDimension < Integer.MAX_VALUE) {
                    system.addLowerThan(end3, begin3, maxDimension, i);
                }
            } else {
                system.addEquality(end3, begin3, dimension3, 8);
            }
        ...
        } else if (numConnections3 == 2 || useRatio || !(matchConstraintDefault5 == 1 || matchConstraintDefault5 == 0)) {
            ...
            if (matchMinDimension3 > 0) {
                system.addGreaterThan(end3, begin3, matchMinDimension3, 8);
            ...
            if (matchMaxDimension3 > 0) {
                ...
                if (applyLimit) {
                    system.addLowerThan(end3, begin3, matchMaxDimension3, 8);
                }
            ...
            if (matchConstraintDefault5 == 1) {
                if (parentWrapContent) {
                    ...
                    system.addEquality(end3, begin3, dimension3, 5);
                    system.addLowerThan(end3, begin3, dimension3, 8);
                } else {
                    system.addEquality(end3, begin3, dimension3, 5);
                    system.addLowerThan(end3, begin3, dimension3, 8);
                }
                ...
                system.addConstraint(system.createRow().createRowDimensionRatio(end3, begin3, percentEnd, percentBegin, matchPercentDimension));
                if (parentWrapContent) {
                    variableSize2 = false;
                }
                matchMinDimension2 = matchMinDimension3;
            ...
            system.addEquality(end3, begin3, d, 8);
            isTerminal2 = isTerminal;
            matchMaxDimension2 = matchMaxDimension;
            beginTarget = beginTarget3;
            numConnections = numConnections3;
        ...
        if (!applyPosition || inChain) {
            ...
            SolverVariable end4 = end;
            boolean isTerminal4 = isTerminal2;
            int numConnections4 = numConnections;
            int i2 = 0;
            SolverVariable solverVariable3 = parentMin;
            if (numConnections4 < 2 && parentWrapContent && isTerminal4) {
                system.addGreaterThan(begin4, solverVariable3, i2, 8);
                int i3 = (isHorizontal || constraintWidget2.mBaseline.mTarget == null) ? 1 : i2;
                if (!isHorizontal && constraintWidget2.mBaseline.mTarget != null) {
                    ConstraintWidget target = constraintWidget2.mBaseline.mTarget.mOwner;
                    i3 = (target.mDimensionRatio != 0.0f && target.mListDimensionBehaviors[i2] == DimensionBehaviour.MATCH_CONSTRAINT && target.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) ? 1 : 0;
                }
                if (i3 != 0) {
                    system.addGreaterThan(solverVariable2, end4, i2, 8);
                    return;
                }
                return;
            }
        ...
        if (isBeginConnected || isEndConnected || isCenterConnected) {
            if (isBeginConnected && !isEndConnected) {
                ...
                if (!parentWrapContent) {
                    ...
                    endTarget2 = endTarget;
                } else if (this.OPTIMIZE_WRAP && begin3.isFinalValue && this.mParent != null) {
                ...
                if (!variableSize2) {
                    ...
                    if (beginTarget2.isFinalValue && endTarget.isFinalValue) {
                        ...
                        system.addCentering(begin3, beginTarget2, beginAnchor.getMargin(), bias, endTarget, end, endAnchor.getMargin(), 8);
                    ...
                    if (matchMaxDimension2 == 0 && matchMinDimension2 == 0) {
                        ...
                        beginTarget2 = beginTarget;
                        boolean applyRangeCheck3 = beginTarget2.isFinalValue;
                        if (applyRangeCheck3 && endTarget.isFinalValue) {
                            system.addEquality(begin3, beginTarget2, beginAnchor.getMargin(), 8);
                            system.addEquality(end, endTarget, -endAnchor.getMargin(), 8);
                            return;
                        } else {
                    ...
                    if ((beginWidget5 instanceof Barrier) || (endWidget3 instanceof Barrier)) {
                        ...
                        matchConstraintDefault3 = matchConstraintDefault6;
                        parent = parent4;
                        applyCentering2 = applyRangeCheck2;
                        matchConstraintDefault4 = 5;
                        endTarget2 = endTarget;
                        endTarget3 = parentMax;
                    } else {
                    ...
                    if (matchConstraintDefault6 == 2) {
                        ...
                        if (useRatio) {
                            ...
                            if (matchMaxDimension2 > 0) {
                                ...
                                rangeCheckStrength4 = (beginWidget5 == parent4 || endWidget3 == parent4) ? 5 : 4;
                                boundsCheckStrength2 = 4;
                                applyCentering = true;
                                endWidget = endWidget3;
                                applyCentering2 = true;
                ...
                if (applyCentering2 && beginTarget2 == endTarget2) {
                    parent2 = parent;
                    ...
                    if (applyCentering) {
                        ...
                        if (variableSize2 || oppositeVariable || oppositeInChain) {
                            ...
                            wrapStrength = matchConstraintDefault4;
                            solverVariable = parentMin;
                            if (beginTarget2 == solverVariable && endTarget2 == endTarget3) {
                                centeringStrength = 8;
                            ...
                            parent3 = parent2;
                            beginWidget3 = beginWidget2;
                            system.addCentering(begin, beginTarget2, beginAnchor.getMargin(), bias, endTarget2, end2, endAnchor.getMargin(), centeringStrength);
                        }
                        rangeCheckStrength = rangeCheckStrength4;
                        applyBoundsCheck = applyBoundsCheck2;
                        parentWrapContent2 = parentWrapContent;
                    ...
                    if (constraintWidget.mVisibility != 8 && !endAnchor.hasDependents()) {
                        return;
                    }
                    if (applyRangeCheck) {
                        begin2 = begin;
                        ...
                        if (!parentWrapContent2 || beginTarget2 == endTarget2 || variableSize2) {
                            ...
                            if (beginWidget6 instanceof Barrier) {
                                ...
                                endWidget2 = endWidget;
                                if (endWidget2 instanceof Barrier) {
                                }
                                begin2 = begin;
                                system.addGreaterThan(begin2, beginTarget2, beginAnchor.getMargin(), rangeCheckStrength3);
                                system.addLowerThan(end2, endTarget2, -endAnchor.getMargin(), rangeCheckStrength3);
                    ...
                    if (applyBoundsCheck) {
                        if (applyStrongChecks && (!oppositeInChain || oppositeParentWrapContent)) {
                            ...
                            if (beginWidget6 == parent3 || endWidget2 == parent3) {
                                strength = 6;
                            }
                            if ((beginWidget6 instanceof Guideline) || (endWidget2 instanceof Guideline)) {
                                strength = 5;
                            }
                            if ((beginWidget6 instanceof Barrier) || (endWidget2 instanceof Barrier)) {
                                strength = 5;
                            }
                            if (oppositeInChain) {
                                strength = 5;
                        ...
                        system.addEquality(begin2, beginTarget2, beginAnchor.getMargin(), boundsCheckStrength);
                        system.addEquality(end2, endTarget2, -endAnchor.getMargin(), boundsCheckStrength);
                    }
                    if (parentWrapContent2) {
                        int margin2 = solverVariable == beginTarget2 ? beginAnchor.getMargin() : 0;
                        if (beginTarget2 != solverVariable) {
                            system.addGreaterThan(begin2, solverVariable, margin2, matchConstraintDefault2);
                        }
                    }
                    if (!parentWrapContent2 && variableSize2 && minDimension == 0 && matchMinDimension2 == 0) {
                        if (variableSize2 && matchConstraintDefault3 == 3) {
                            system.addGreaterThan(end2, begin2, 0, 8);
                        } else {
                            int i4 = 0;
                            system.addGreaterThan(end2, begin2, i4, matchConstraintDefault2);
                        }
                    }
                } else {
                    parent2 = parent;
            ...
            if (parentWrapContent2 || !isTerminal3) {
            }
            int margin3 = endAnchor.mTarget != null ? endAnchor.getMargin() : 0;
            if (endTarget2 != parentMax) {
                if (!constraintWidget.OPTIMIZE_WRAP || !end2.isFinalValue || constraintWidget.mParent == null) {
                    system.addGreaterThan(parentMax, end2, margin3, matchConstraintDefault2);
                    return;
                }
                ConstraintWidgetContainer container2 = (ConstraintWidgetContainer) constraintWidget.mParent;
                if (isHorizontal) {
