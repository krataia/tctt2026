    ...
    */
    public void transitionToState(int id, int screenWidth, int screenHeight, int duration) {
        ...
        if (this.mScene == null || this.mScene.mStateSet == null) {
            ...
            if (this.mCurrentState != -1) {
                setTransition(this.mCurrentState, id2);
                animateTo(1.0f);
                this.mTransitionLastPosition = 0.0f;
                transitionToEnd();
                if (duration > 0) {
            ...
            if (this.mDecoratorsHelpers != null) {
                ...
                for (MotionHelper mDecoratorsHelper : this.mDecoratorsHelpers) {
            ...
            if (stagger != 0.0f) {
                ...
                for (int i8 = 0; i8 < n; i8++) {
                    MotionController f = this.mFrameArrayList.get(getChildAt(i8));
                    float x = f.getFinalX();
                    float y = f.getFinalY();
                ...
                for (int i9 = 0; i9 < n; i9++) {
                    MotionController f2 = this.mFrameArrayList.get(getChildAt(i9));
    ...
    void evaluate(boolean force) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != this.mTransitionLastPosition))) {
            ...
            float deltaPos = 0.0f;
            if (!(this.mInterpolator instanceof MotionInterpolator)) {
                deltaPos = (((currentTime - this.mTransitionLastTime) * dir2) * 1.0E-9f) / this.mTransitionDuration;
            }
            float position = this.mTransitionLastPosition + deltaPos;
            boolean done = false;
            if (this.mTransitionInstantly) {
