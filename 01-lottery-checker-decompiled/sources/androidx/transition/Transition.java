    ...
    void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        while (i4 < size) {
            ...
            if (transitionValues == null && transitionValues3 == null) {
                ...
                z = z2;
                i2 = i4;
            } else if (transitionValues == null || transitionValues3 == null || isTransitionRequired(transitionValues, transitionValues3)) {
                Animator animatorCreateAnimator = createAnimator(viewGroup, transitionValues, transitionValues3);
                if (animatorCreateAnimator != null) {
                    ...
                    if (transitionValues3 != null) {
                        ...
                        if (transitionProperties != null) {
                            ...
                            if (transitionProperties.length <= 0) {
                                ...
                                i = size;
                                TransitionValues transitionValues6 = transitionValuesMaps2.mViewValues.get(view);
                                if (transitionValues6 != null) {
                                    int i5 = 0;
                                    while (i5 < transitionProperties.length) {
                                        transitionValues5.values.put(transitionProperties[i5], transitionValues6.values.get(transitionProperties[i5]));
                                        i5++;
                                ...
                                while (true) {
                                    ...
                                    if (animationInfo.mValues == null || animationInfo.mView != view) {
                                        ...
                                        i3 = size2;
                                        if (animationInfo.mName.equals(getName()) && animationInfo.mValues.equals(transitionValues5)) {
                                            transitionValues4 = transitionValues5;
                                            animator3 = null;
                                            break;
                                        }
                    ...
                    if (animator != null) {
                        if (this.mPropagation != null) {
                            long startDelay = this.mPropagation.getStartDelay(viewGroup, this, transitionValues, transitionValues3);
                            sparseIntArray.put(this.mAnimators.size(), (int) startDelay);
                            jMin = Math.min(startDelay, j);
                        } else {
                            jMin = j;
                        }
                        AnimationInfo animationInfo2 = new AnimationInfo(view, getName(), this, viewGroup.getWindowId(), transitionValues4, animator);
                        ...
                        runningAnimators.put(animator4, animationInfo2);
                        this.mAnimators.add(animator4);
                        j = jMin;
                    }
                } else {
                    i = size;
        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.Transition$SeekController$$ExternalSyntheticLambda0
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    this.f$0.m63x76b2d240(dynamicAnimation, z, f, f2);
                }
            });
        }
