...
public final class URandomKt {
    public static final int nextUInt(Random $this$nextUInt) {
        ...
        return UInt.m136constructorimpl($this$nextUInt.nextInt());
    }

    /* JADX INFO: renamed from: nextUInt-qCasIEU, reason: not valid java name */
    public static final int m1268nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return m1267nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* JADX INFO: renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m1267nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        m1262checkUIntRangeBoundsJ1ME1BU(from, until);
        ...
        return UInt.m136constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        return UnsignedKt.uintCompare(range.getLast(), -1) < 0 ? m1267nextUInta8DCA5k($this$nextUInt, range.getFirst(), UInt.m136constructorimpl(range.getLast() + 1)) : UnsignedKt.uintCompare(range.getFirst(), 0) > 0 ? UInt.m136constructorimpl(m1267nextUInta8DCA5k($this$nextUInt, UInt.m136constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt($this$nextUInt);
    }

    public static final long nextULong(Random $this$nextULong) {
        Intrinsics.checkNotNullParameter($this$nextULong, "<this>");
        return ULong.m214constructorimpl($this$nextULong.nextLong());
    }

    /* JADX INFO: renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m1269nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return m1270nextULongjmpaWc(nextULong, 0L, until);
    }

    /* JADX INFO: renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m1270nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        m1263checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m214constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (UnsignedKt.ulongCompare(range.getLast(), -1L) < 0) {
            return m1270nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m214constructorimpl(range.getLast() + ULong.m214constructorimpl(((long) 1) & 4294967295L)));
        }
        if (UnsignedKt.ulongCompare(range.getFirst(), 0L) <= 0) {
            return nextULong($this$nextULong);
        }
        long j = ((long) 1) & 4294967295L;
        return ULong.m214constructorimpl(m1270nextULongjmpaWc($this$nextULong, ULong.m214constructorimpl(range.getFirst() - ULong.m214constructorimpl(j)), range.getLast()) + ULong.m214constructorimpl(j));
    }

    /* JADX INFO: renamed from: nextUBytes-EVgfTAA, reason: not valid java name */
    public static final byte[] m1264nextUBytesEVgfTAA(Random nextUBytes, byte[] array) {
    ...
    public static final byte[] nextUBytes(Random $this$nextUBytes, int size) {
        ...
        return UByteArray.m112constructorimpl($this$nextUBytes.nextBytes(size));
    }

    /* JADX INFO: renamed from: nextUBytes-Wvrt4B4$default, reason: not valid java name */
    public static /* synthetic */ byte[] m1266nextUBytesWvrt4B4$default(Random random, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m1265nextUBytesWvrt4B4(random, bArr, i, i2);
    }

    /* JADX INFO: renamed from: nextUBytes-Wvrt4B4, reason: not valid java name */
    public static final byte[] m1265nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(array, "array");
    ...
    public static final void m1262checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(UnsignedKt.uintCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m130boximpl(from), UInt.m130boximpl(until)).toString());
        }
    }

    /* JADX INFO: renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m1263checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(UnsignedKt.ulongCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m208boximpl(from), ULong.m208boximpl(until)).toString());
        }
    }
}
