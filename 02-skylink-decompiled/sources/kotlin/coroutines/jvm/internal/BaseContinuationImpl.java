...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            Continuation<Object> continuation = $this$resumeWith_u24lambda_u2d0.completion;
            Intrinsics.checkNotNull(continuation);
            try {
                outcome = $this$resumeWith_u24lambda_u2d0.invokeSuspend(param);
            } catch (Throwable exception) {
                Result.Companion companion = Result.INSTANCE;
                objM42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(outcome);
            Object outcome2 = objM42constructorimpl;
