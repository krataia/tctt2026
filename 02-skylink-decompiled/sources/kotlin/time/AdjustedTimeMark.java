...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1348elapsedNowUwyO8pc() {
        return Duration.m1391minusLRDsOJo(this.mark.mo1348elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1350plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1392plusLRDsOJo(this.adjustment, duration), null);
    }
}
