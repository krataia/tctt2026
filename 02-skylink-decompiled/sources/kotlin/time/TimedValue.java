...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1508copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1510copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1510copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1361equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1384hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1405toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1511getDurationUwyO8pc() {
        return this.duration;
    }
