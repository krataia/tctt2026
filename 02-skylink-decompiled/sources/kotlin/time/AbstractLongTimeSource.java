...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark mo1350plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1392plusLRDsOJo(this.offset, duration), null);
        }
    }

    @Override // kotlin.time.TimeSource
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.INSTANCE.m1458getZEROUwyO8pc(), null);
    }
}
