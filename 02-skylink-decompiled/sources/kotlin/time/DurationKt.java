...
public final class DurationKt {
    ...
    private static final long m1482timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1394timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1481timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1393timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    public static final long parseDuration(String value, boolean strictIso) {
        ...
        long result2 = Duration.INSTANCE.m1458getZEROUwyO8pc();
        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index2 < length3) {
                if (value.charAt(index2) == 'T') {
                    ...
                    if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                        ...
                        String str5 = str3;
                        long result3 = Duration.m1392plusLRDsOJo(result2, toDuration(parseOverLongIsoComponent(whole), unit));
                        Intrinsics.checkNotNull(component, str5);
                        String strSubstring = component.substring(dotIndex);
                        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                        result2 = Duration.m1392plusLRDsOJo(result3, toDuration(Double.parseDouble(strSubstring), unit));
                        str3 = str5;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
                        ...
                        result2 = Duration.m1392plusLRDsOJo(result2, toDuration(parseOverLongIsoComponent(component), unit));
                        str3 = str3;
                        nonDigitSymbols2 = nonDigitSymbols;
                        length3 = length2;
                        isNegative3 = isNegative2;
            ...
            if (!strictIso) {
                if (StringsKt.regionMatches(value, index, "Infinity", 0, Math.max(length3 - index, "Infinity".length()), true)) {
                    result2 = Duration.INSTANCE.m1456getINFINITEUwyO8pc();
                } else {
                    ...
                    while (index < length) {
                        ...
                        if (dotIndex2 > 0) {
                            ...
                            String str6 = str;
                            long result4 = Duration.m1392plusLRDsOJo(result, toDuration(Long.parseLong(whole2), unit2));
                            Intrinsics.checkNotNull(component2, "null cannot be cast to non-null type java.lang.String");
                            String strSubstring2 = component2.substring(dotIndex2);
                            Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                            result = Duration.m1392plusLRDsOJo(result4, toDuration(Double.parseDouble(strSubstring2), unit2));
                            if (index < length) {
                            ...
                            result = Duration.m1392plusLRDsOJo(result, toDuration(Long.parseLong(component2), unit2));
                            str = str;
                            allowSpaces2 = allowSpaces;
                            afterFirst = true;
                        }
        ...
        return isNegative ? Duration.m1408unaryMinusUwyO8pc(result2) : result2;
    }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1356constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1356constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1356constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
