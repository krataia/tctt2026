...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00371<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00371(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00371> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00371 c00371 = new C00371(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00371.L$0 = obj;
            return c00371;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00371(sequence, defaultValue, null));
    }
    ...
    static final class C00381<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00381(Sequence<? extends T> sequence, Random random, Continuation<? super C00381> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00381 c00381 = new C00381(this.$this_shuffled, this.$random, continuation);
            c00381.L$0 = obj;
            return c00381;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00381 = this;
                    sequenceScope = (SequenceScope) c00381.L$0;
                    mutableList = SequencesKt.toMutableList(c00381.$this_shuffled);
                    break;
                case 1:
                    c00381 = this;
                    mutableList = (List) c00381.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c00381.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00381.$random.nextInt(mutableList.size());
                ...
                c00381.L$0 = sequenceScope;
                c00381.L$1 = mutableList;
                c00381.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00381) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00381(sequence, random, null));
    }
    ...
    static final class C00331<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00331(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00331> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00331 c00331 = new C00331(this.$source, this.$transform, this.$iterator, continuation);
            c00331.L$0 = obj;
            return c00331;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00331 = this;
                    sequenceScope = (SequenceScope) c00331.L$0;
                    i = 0;
                    it = c00331.$source.iterator();
                    break;
                case 1:
                    c00331 = this;
                    i = c00331.I$0;
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00331.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00331.L$0 = sequenceScope;
                c00331.L$1 = it;
                c00331.I$0 = i2;
                c00331.label = 1;
                if (sequenceScope.yieldAll(c00331.$iterator.invoke((C) objInvoke), c00331) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00331(source, transform, iterator, null));
    }
