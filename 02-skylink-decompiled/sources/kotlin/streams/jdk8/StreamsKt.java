...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return StreamsKt.m1335asStream$lambda4(sequence);
            }
        }, 16, false);
    ...
    /* JADX INFO: renamed from: asStream$lambda-4, reason: not valid java name */
    public static final Spliterator m1335asStream$lambda4(Sequence this_asStream) {
