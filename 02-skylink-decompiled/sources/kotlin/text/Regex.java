...
public final class Regex implements Serializable {
    ...
    public final Set<RegexOption> getOptions() {
        ...
        Set<RegexOption> setUnmodifiableSet = Collections.unmodifiableSet($this$fromInt_u24lambda_u2d1$iv);
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C00601(input, limit, null));
    }
    ...
    static final class C00601 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00601(CharSequence charSequence, int i, Continuation<? super C00601> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00601 c00601 = Regex.this.new C00601(this.$input, this.$limit, continuation);
            c00601.L$0 = obj;
            return c00601;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00601 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00601.L$0;
                    matcher = Regex.this.nativePattern.matcher(c00601.$input);
                    if (c00601.$limit == 1 || !matcher.find()) {
                        c00601.label = 1;
                        return $this$sequence2.yield(c00601.$input.toString(), c00601) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c00601.L$0 = $this$sequence;
                    c00601.L$1 = matcher;
                    c00601.I$0 = splitCount;
                    c00601.label = 2;
                    if ($this$sequence.yield(c00601.$input.subSequence(nextStart, matcher.start()).toString(), c00601) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00601.$limit - 1 || !matcher.find()) {
                        c00601.L$0 = null;
                        c00601.L$1 = null;
                        c00601.label = 3;
                        return $this$sequence.yield(c00601.$input.subSequence(nextStart, c00601.$input.length()).toString(), c00601) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    c00601.L$0 = $this$sequence;
                    c00601.L$1 = matcher;
                    c00601.I$0 = splitCount;
                    ...
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00601.$limit - 1) {
                    }
                    c00601.L$0 = null;
                    c00601.L$1 = null;
                    c00601.label = 3;
                    if ($this$sequence.yield(c00601.$input.subSequence(nextStart, c00601.$input.length()).toString(), c00601) == coroutine_suspended) {
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                case 2:
                    c00601 = this;
                    splitCount = c00601.I$0;
                    matcher = (Matcher) c00601.L$1;
                    $this$sequence = (SequenceScope) c00601.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00601.$limit - 1) {
