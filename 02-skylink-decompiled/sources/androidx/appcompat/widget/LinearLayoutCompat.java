                            ...
                            while (i13 < count) {
                                ...
                                if (child4 != null) {
                                    ...
                                    if (alternativeMaxWidth9 == 8) {
                                        ...
                                        delta5 = delta6;
                                        child4.measure(View.MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(largestChildHeight7, 1073741824));
                                    } else {
                                        delta5 = delta6;
                                    }
                                } else {
                    ...
                    while (i12 < count) {
                        ...
                        if (child3 != null) {
                            ...
                            if (alternativeMaxHeight11 == 8) {
                                ...
                                int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(largestChildWidth12, 1073741824);
                                largestChildWidth2 = largestChildWidth12;
                                int largestChildWidth14 = child3.getMeasuredHeight();
                                child3.measure(iMakeMeasureSpec, View.MeasureSpec.makeMeasureSpec(largestChildWidth14, 1073741824));
                            } else {
                                largestChildWidth2 = largestChildWidth12;
                            }
                        } else {
