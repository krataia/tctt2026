        ...
        if (event.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (vscroll != 0.0f) {
                ...
                if (newScrollY < 0) {
                    ...
                    if (canOverScroll) {
                        EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, (-newScrollY) / getHeight(), MAX_SCROLL_FACTOR);
                        this.mEdgeGlowTop.onRelease();
                        invalidate();
                        absorbed = true;
                    }
                    ...
                    if (canOverScroll) {
                        EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, (newScrollY - range) / getHeight(), MAX_SCROLL_FACTOR);
                        this.mEdgeGlowBottom.onRelease();
                        invalidate();
                        absorbed = true;
                    }
