    ...
    private static class Impl21 extends Impl {
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(final View v, WindowInsets insets) {
                ...
                Impl21.dispatchOnPrepare(v, anim, insets, WindowInsetsAnimationCompat.DEBUG);
        ...
        static void dispatchOnPrepare(View v, WindowInsetsAnimationCompat anim, WindowInsets insets, boolean stopDispatch) {
            ...
            if (callback != null) {
                ...
                if (!stopDispatch) {
                    ...
                    stopDispatch = callback.getDispatchMode() == 0 ? true : WindowInsetsAnimationCompat.DEBUG;
                }
            }
