...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m1535boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m1536constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m1542hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m1537equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1542hashCodeimpl(this.holder);
    }
    ...
    public static final T m1541getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m1539exceptionOrNullimpl(Object arg0) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1550successJP2dKIU(E value) {
            return ChannelResult.m1536constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m1549failurePtdJZtk() {
            return ChannelResult.m1536constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m1548closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1536constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m1546toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1546toStringimpl(Object arg0) {
