...
public interface SendChannel<E> {
    ...
    Object mo1530trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1530trySendJP2dKIU(e);
            if (ChannelResult.m1545isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1539exceptionOrNullimpl = ChannelResult.m1539exceptionOrNullimpl(result);
