...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1528receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        switch (abstractChannel$receiveCatching$12.label) {
            case 0:
                ...
                if (result != AbstractChannelKt.POLL_FAILED) {
                    return result instanceof Closed ? ChannelResult.INSTANCE.m1548closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1550successJP2dKIU(result);
                }
    ...
    public final Object mo1529tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1549failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1548closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1550successJP2dKIU(result);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1567constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1575remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1572plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1527onCancelIdempotentListww6eGU(list, closedForSend);
                return;
            }
        }
    }
    ...
    protected void mo1527onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) throws Throwable {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1535boximpl(ChannelResult.INSTANCE.m1548closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1535boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1548closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1550successJP2dKIU(value));
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1535boximpl(ChannelResult.INSTANCE.m1550successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m42constructorimpl(ChannelResult.m1535boximpl(ChannelResult.INSTANCE.m1548closedJP2dKIU(closed.closeCause))));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1535boximpl(ChannelResult.INSTANCE.m1550successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        break;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1535boximpl(ChannelResult.INSTANCE.m1548closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        break;
                }
            }
        }
