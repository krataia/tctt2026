...
public interface ReceiveChannel<E> {
    ...
    Object mo1528receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1529tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1529tryReceivePtdJZtk = receiveChannel.mo1529tryReceivePtdJZtk();
            if (ChannelResult.m1545isSuccessimpl(objMo1529tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1541getOrThrowimpl(objMo1529tryReceivePtdJZtk);
            }
            Throwable thM1539exceptionOrNullimpl = ChannelResult.m1539exceptionOrNullimpl(objMo1529tryReceivePtdJZtk);
            if (thM1539exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1539exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass12.label) {
                case 0:
                    ...
                    objMo1528receiveCatchingJP2dKIU = receiveChannel.mo1528receiveCatchingJP2dKIU(anonymousClass12);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1528receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1540getOrNullimpl(objMo1528receiveCatchingJP2dKIU);
        }
