...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1557debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1515toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1515toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    static final class C01072<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01072(long j, Flow<? extends T> flow, Continuation<? super C01072> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C01072 c01072 = new C01072(this.$periodMillis, this.$this_sample, continuation);
            c01072.L$0 = coroutineScope;
            c01072.L$1 = flowCollector;
            return c01072.invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Can't wrap try/catch for region: R(15:10|(1:43)|11|41|12|13|39|14|15|16|37|17|28|(1:30)|(1:32)(4:33|34|8|(2:35|36)(0))) */
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:33:0x00d1 -> B:34:0x00d3). Please report as a decompilation issue!!! */
            ...
            switch (this.label) {
                case 0:
                    ...
                    if (lastValue.element != NullSurrogateKt.DONE) {
                        c01072.L$0 = downstream;
                        c01072.L$1 = values;
                        c01072.L$2 = lastValue;
                        c01072.L$3 = ticker;
                        c01072.label = 1;
                        Continuation uCont$iv = c01072;
                        ...
                        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            DebugProbesKt.probeCoroutineSuspended(c01072);
                        }
                        if (result != obj) {
                            return obj;
                        }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new C01072(periodMillis, flow, null));
        }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return ProduceKt.produce$default($this$fixedPeriodTicker, null, 0, new C01063(initialDelayMillis, delayMillis, null), 1, null);
    }
    ...
    static final class C01063 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01063(long j, long j2, Continuation<? super C01063> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01063 c01063 = new C01063(this.$initialDelayMillis, this.$delayMillis, continuation);
            c01063.L$0 = obj;
            return c01063;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C01063) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L6c:
                goto L46
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C01063.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* JADX INFO: renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m1558sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1515toDelayMillisLRDsOJo(period));
    }
}
