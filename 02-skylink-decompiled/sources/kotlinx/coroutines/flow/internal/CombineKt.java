        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    holder = resultChannel.mo1528receiveCatchingJP2dKIU(anonymousClass2);
                    if (holder == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    latestValues2 = latestValues;
                    element = (IndexedValue) ChannelResult.m1540getOrNullimpl(holder);
                    if (element != null) {
                        return Unit.INSTANCE;
                    }
                    do {
                        ...
                        if (lastReceivedEpoch[index] != remainingAbsentValues) {
                            ...
                            element = (IndexedValue) ChannelResult.m1540getOrNullimpl(resultChannel.mo1529tryReceivePtdJZtk());
                        }
