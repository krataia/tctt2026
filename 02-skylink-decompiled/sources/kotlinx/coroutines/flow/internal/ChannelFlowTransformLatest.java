...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3", f = "Merge.kt", i = {}, l = {MotionEventCompat.AXIS_RELATIVE_X}, m = "invokeSuspend", n = {}, s = {})
        ...
        static final class AnonymousClass1<T> implements FlowCollector, SuspendFunction {
            ...
            */
            public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
                ...
                ChannelFlowTransformLatest$flowCollect$3$1$emit$1 channelFlowTransformLatest$flowCollect$3$1$emit$12 = channelFlowTransformLatest$flowCollect$3$1$emit$1;
                Object obj2 = channelFlowTransformLatest$flowCollect$3$1$emit$12.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch (channelFlowTransformLatest$flowCollect$3$1$emit$12.label) {
                    case 0:
                        ...
                        return Unit.INSTANCE;
                    case 1:
                        obj = channelFlowTransformLatest$flowCollect$3$1$emit$12.L$1;
