            ...
            static final class C00041 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                */
                public final Object invokeSuspend(Object obj) throws Throwable {
                    C00041 c00041;
                    Object objMo1528receiveCatchingJP2dKIU;
                    Object obj2;
                    C00041 c000412;
                    ?? r4;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    switch (this.label) {
                        case 0:
                            ...
                            c00041 = this;
                            c00041.label = 1;
                            objMo1528receiveCatchingJP2dKIU = c00041.$second.mo1528receiveCatchingJP2dKIU(c00041);
                            if (objMo1528receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            FlowCollector flowCollector = c00041.$this_unsafeFlow;
                            if (!(objMo1528receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                                Throwable thM1539exceptionOrNullimpl = ChannelResult.m1539exceptionOrNullimpl(objMo1528receiveCatchingJP2dKIU);
                                if (thM1539exceptionOrNullimpl == null) {
                                    throw new AbortFlowException(flowCollector);
                                }
                                throw thM1539exceptionOrNullimpl;
                            }
                            Object obj3 = c00041.$this_unsafeFlow;
                            Function3 function3 = c00041.$transform;
                            Object obj4 = c00041.$value;
                            if (objMo1528receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                objMo1528receiveCatchingJP2dKIU = null;
                            }
                            c00041.L$0 = obj3;
                            c00041.label = 2;
                            Object objInvoke = function3.invoke(obj4, objMo1528receiveCatchingJP2dKIU, c00041);
                            if (objInvoke == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            C00041 c000413 = c00041;
                            obj2 = obj;
                            obj = objInvoke;
                            c000412 = c000413;
                            r4 = obj3;
                            c000412.L$0 = null;
                            c000412.label = 3;
                            return r4.emit(obj, c000412) != coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                        case 1:
                            c00041 = this;
                            ResultKt.throwOnFailure(obj);
                            objMo1528receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                            FlowCollector flowCollector2 = c00041.$this_unsafeFlow;
                            if (!(objMo1528receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                            }
                            break;
                        case 2:
                            ...
                            c000412.L$0 = null;
                            c000412.label = 3;
                            if (r4.emit(obj, c000412) != coroutine_suspended) {
                            }
                            break;
                        case 3:
                            ResultKt.throwOnFailure(obj);
            ...
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                switch (combineKt$zipImpl$1$1$2$1$emit$12.label) {
                    case 0:
                        ...
                        if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj, c00041, combineKt$zipImpl$1$1$2$1$emit$12) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                    case 1:
