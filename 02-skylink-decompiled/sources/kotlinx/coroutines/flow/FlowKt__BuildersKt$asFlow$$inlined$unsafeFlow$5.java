    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass12.label) {
            ...
            case 1:
                ...
                $this$asFlow_u24lambda_u2d7 = (FlowCollector) anonymousClass12.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
        ...
        while (it.hasNext()) {
            T next = it.next();
            anonymousClass12.L$0 = $this$asFlow_u24lambda_u2d7;
            anonymousClass12.L$1 = it;
            anonymousClass12.label = 1;
            Object value = $this$asFlow_u24lambda_u2d7.emit(next, anonymousClass12);
