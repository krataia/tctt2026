    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (anonymousClass12.label) {
            case 0:
                ...
                try {
                    anonymousClass12.L$0 = collector$iv2;
                ...
                return $this$collectWhile$iv.collect(collector$iv2, anonymousClass12) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
            case 1:
                collector$iv = (FlowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$1) anonymousClass12.L$0;
                try {
                    ResultKt.throwOnFailure($result);
