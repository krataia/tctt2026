...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    static final class C01131<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {183}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C01143<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C01143(Continuation<? super C01143> continuation) {
            super(continuation);
        }
    ...
    static final class C01151<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01161<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01201<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    */
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        switch (c012012.label) {
            case 0:
                ...
                FlowCollector<? super Object> c01212 = new C01212<>(accumulator2, function3);
                c012012.L$0 = accumulator2;
                c012012.label = 1;
                ...
                break;
            case 1:
                accumulator = (Ref.ObjectRef) c012012.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
    ...
    static final class C01212<T> implements FlowCollector, SuspendFunction {
        ...
        C01212(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    */
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        ...
        C01151 c011512 = c01151;
        Object $result = c011512.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c011512.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                Ref.ObjectRef accumulator2 = new Ref.ObjectRef();
                accumulator2.element = r;
                FlowCollector<? super Object> anonymousClass2 = new AnonymousClass2<>(accumulator2, function3);
                c011512.L$0 = accumulator2;
                c011512.label = 1;
                if (flow.collect(anonymousClass2, c011512) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                accumulator = accumulator2;
                break;
            case 1:
                accumulator = (Ref.ObjectRef) c011512.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    */
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        switch (c012212.label) {
            case 0:
                ...
                FlowCollector<? super Object> c01232 = new C01232<>(objectRef2);
    ...
    static final class C01232<T> implements FlowCollector, SuspendFunction {
        ...
        C01232(Ref.ObjectRef<Object> objectRef) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        switch (c012412.label) {
            case 0:
                ...
                try {
                    c012412.L$0 = objectRef;
                    c012412.L$1 = flowCollector2;
                    c012412.label = 1;
                    break;
                ...
                if (flow.collect(flowCollector2, c012412) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                if (objectRef.element != NullSurrogateKt.NULL) {
                    return null;
                ...
                return objectRef.element;
            case 1:
                flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c012412.L$1;
                objectRef = (Ref.ObjectRef) c012412.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
    ...
    */
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        C01131 c011312 = c01131;
        Object $result = c011312.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c011312.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                ...
                return flow.collect(flowCollector2, c011312) == coroutine_suspended ? coroutine_suspended : result.element;
            case 1:
                flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c011312.L$1;
                result = (Ref.ObjectRef) c011312.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                } catch (AbortFlowException e2) {
                    e$iv = e2;
    ...
    */
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e$iv;
        if (continuation instanceof C01143) {
            c01143 = (C01143) continuation;
            if ((c01143.label & Integer.MIN_VALUE) != 0) {
                c01143.label -= Integer.MIN_VALUE;
            } else {
                c01143 = new C01143(continuation);
            }
        }
        C01143 c011432 = c01143;
        Object $result = c011432.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c011432.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                ...
                if (flow.collect(collector$iv2, c011432) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                result = result2;
                return result.element;
            case 1:
                collector$iv = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c011432.L$1;
                result = (Ref.ObjectRef) c011432.L$0;
                try {
                    ResultKt.throwOnFailure($result);
                    break;
                } catch (AbortFlowException e2) {
    ...
    */
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        switch (c011612.label) {
            case 0:
                ...
                Ref.ObjectRef objectRef2 = new Ref.ObjectRef();
                objectRef2.element = (T) NullSurrogateKt.NULL;
                FlowCollector<? super Object> c01172 = new C01172<>(objectRef2);
                c011612.L$0 = objectRef2;
                c011612.label = 1;
                ...
                break;
            case 1:
                objectRef = (Ref.ObjectRef) c011612.L$0;
                ResultKt.throwOnFailure(obj);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    static final class C01172<T> implements FlowCollector, SuspendFunction {
        ...
        C01172(Ref.ObjectRef<Object> objectRef) {
            this.$result = objectRef;
        }
    ...
    */
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        Object $result = c011812.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (c011812.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                Ref.ObjectRef result2 = new Ref.ObjectRef();
                FlowCollector<? super Object> c01192 = new C01192<>(result2);
                c011812.L$0 = result2;
                c011812.label = 1;
                ...
                break;
            case 1:
                result = (Ref.ObjectRef) c011812.L$0;
                ResultKt.throwOnFailure($result);
                break;
            default:
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    static final class C01192<T> implements FlowCollector, SuspendFunction {
        ...
        C01192(Ref.ObjectRef<T> objectRef) {
            this.$result = objectRef;
        }
