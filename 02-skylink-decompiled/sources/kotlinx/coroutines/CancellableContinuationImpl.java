...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    private final void releaseClaimedReusableContinuation() {
        ...
        Throwable cancellationCause = thTryReleaseClaimedContinuation;
        detachChild$kotlinx_coroutines_core();
    ...
    public Throwable getExceptionalResult$kotlinx_coroutines_core(Object state) {
        ...
        if (DebugKt.getRECOVER_STACK_TRACES() && (delegate$kotlinx_coroutines_core instanceof CoroutineStackFrame)) {
            it = StackTraceRecoveryKt.recoverFromStackFrame(it2, (CoroutineStackFrame) delegate$kotlinx_coroutines_core);
        } else {
            it = it2;
        }
        return it;
