...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM42constructorimpl = Result.m42constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM42constructorimpl;
        }
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        it.initCause(e);
                        objM42constructorimpl = Result.m42constructorimpl(it);
                        if (Result.m48isFailureimpl(objM42constructorimpl)) {
                            objM42constructorimpl = null;
                        }
                        return (Throwable) objM42constructorimpl;
                    }
                };
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        objM42constructorimpl = Result.m42constructorimpl((Throwable) objNewInstance);
                        if (Result.m48isFailureimpl(objM42constructorimpl)) {
                            objM42constructorimpl = null;
                        }
                        return (Throwable) objM42constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM42constructorimpl = Result.m42constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m48isFailureimpl(objM42constructorimpl)) {
            objM42constructorimpl = numValueOf;
        }
        return ((Number) objM42constructorimpl).intValue();
    }
