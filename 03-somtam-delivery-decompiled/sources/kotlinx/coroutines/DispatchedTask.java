    ...
    public final void run() {
        ...
        try {
                    ...
                    try {
                        ...
                        try {
                            if (job == null && !job.isActive()) {
                                ...
                                if (DebugKt.getRECOVER_STACK_TRACES()) {
                                    try {
                                        if (continuation instanceof CoroutineStackFrame) {
                                            ...
                                            continuation.resumeWith(Result.m42constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                                        }
                                    } catch (Throwable th) {
                                        th = th;
                                ...
                                continuation.resumeWith(Result.m42constructorimpl(successfulResult$kotlinx_coroutines_core));
                            }
                            ...
                            try {
                                ...
                                result = Result.m42constructorimpl(Unit.INSTANCE);
                            } catch (Throwable th2) {
                                th = th2;
                                Result.Companion companion5 = Result.INSTANCE;
                                result = Result.m42constructorimpl(ResultKt.createFailure(th));
                            }
                        } catch (Throwable th3) {
                            th = th3;
                        }
            ...
            try {
                ...
                DispatchedTask<T> dispatchedTask3 = this;
                taskContext.afterTask();
                result = Result.m42constructorimpl(Unit.INSTANCE);
            } catch (Throwable th6) {
                th = th6;
        ...
        handleFatalException(fatalException, Result.m45exceptionOrNullimpl(result));
    }
