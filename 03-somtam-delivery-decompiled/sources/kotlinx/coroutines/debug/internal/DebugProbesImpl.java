...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (objNewInstance != null) {
            objM42constructorimpl = Result.m42constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            if (Result.m48isFailureimpl(objM42constructorimpl)) {
                objM42constructorimpl = null;
            }
            return (Function1) objM42constructorimpl;
        }
    ...
    private final void startWeakRefCleanerThread() {
        weakRefCleanerThread = ThreadsKt.thread((23 & 1) != 0, (23 & 2) != 0 ? false : true, (23 & 4) != 0 ? null : null, (23 & 8) != 0 ? null : "Coroutines Debugger Cleaner", (23 & 16) != 0 ? -1 : 0, new Function0<Unit>() { // from class: kotlinx.coroutines.debug.internal.DebugProbesImpl.startWeakRefCleanerThread.1
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        for (StackTraceElement element : listEnhanceStackTraceWithThreadDump) {
            ...
            stackTraceElementsInfoAsJson.add(StringsKt.trimIndent(sbAppend.append((Object) (fileName == null ? null : toStringWithQuotes(fileName))).append(",\n                    \"lineNumber\": ").append(element.getLineNumber()).append("\n                }\n                ").toString()));
        }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM42constructorimpl = Result.m42constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] actualTrace = (StackTraceElement[]) objM42constructorimpl;
        if (actualTrace == null) {
            return coroutineTrace;
        }
