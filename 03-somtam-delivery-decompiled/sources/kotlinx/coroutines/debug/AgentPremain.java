...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM42constructorimpl = Result.m42constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m48isFailureimpl(objM42constructorimpl) ? null : objM42constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1571installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1571installSignalHandler$lambda1(Signal it) {
