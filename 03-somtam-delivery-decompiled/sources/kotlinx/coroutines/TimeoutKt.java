...
public final class TimeoutKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.TimeoutKt", f = "Timeout.kt", i = {0, 0, 0}, l = {LocationRequestCompat.QUALITY_HIGH_ACCURACY}, m = "withTimeoutOrNull", n = {"block", "coroutine", "timeMillis"}, s = {"L$0", "L$1", "J$0"})
    ...
    public static final <T> Object m1541withTimeoutKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1533toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
    ...
    */
    public static final <T> Object withTimeoutOrNull(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        switch (anonymousClass12.label) {
            case 0:
                ...
                try {
                    anonymousClass12.L$0 = function2;
                    anonymousClass12.L$1 = objectRef2;
                    anonymousClass12.J$0 = j;
                    anonymousClass12.label = 1;
                    ?? r6 = (T) new TimeoutCoroutine(j, anonymousClass12);
    ...
    public static final <T> Object m1542withTimeoutOrNullKLykuaI(long timeout, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1533toDelayMillisLRDsOJo(timeout), function2, continuation);
    }
