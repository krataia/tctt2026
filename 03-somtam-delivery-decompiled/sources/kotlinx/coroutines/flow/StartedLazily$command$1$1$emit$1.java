...
final class StartedLazily$command$1$1$emit$1 extends ContinuationImpl {
    ...
    final /* synthetic */ StartedLazily.AnonymousClass1.C00021<T> this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    StartedLazily$command$1$1$emit$1(StartedLazily.AnonymousClass1.C00021<? super T> c00021, Continuation<? super StartedLazily$command$1$1$emit$1> continuation) {
        super(continuation);
        this.this$0 = c00021;
    }
