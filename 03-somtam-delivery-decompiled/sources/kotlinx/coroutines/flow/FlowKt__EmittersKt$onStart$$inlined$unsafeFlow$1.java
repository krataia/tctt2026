...
public final class FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        ?? Collect = anonymousClass12.label;
        try {
            switch (Collect) {
                case 0:
                    ...
                    safeCollector = new SafeCollector(flowCollector2, anonymousClass12.getContext());
                    ...
                    InlineMarker.mark(6);
                    Object objInvoke = function2.invoke(safeCollector, anonymousClass12);
                    InlineMarker.mark(7);
                    ...
                    Collect = flow.collect(flowCollector2, anonymousClass12);
                ...
                case 1:
                    ...
                    anonymousClass12.L$2 = null;
                    anonymousClass12.label = 2;
                    Collect = flow2.collect(flowCollector2, anonymousClass12);
                    if (Collect == coroutine_suspended) {
                    }
                    return Unit.INSTANCE;
                case 2:
