    ...
    public static final <T> Object emitAllImpl$FlowKt__ChannelsKt(FlowCollector<? super T> flowCollector, ReceiveChannel<? extends T> receiveChannel, boolean z, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (flowKt__ChannelsKt$emitAllImpl$12.label) {
            case 0:
                ...
                holder = receiveChannel2.mo1546receiveCatchingJP2dKIU(flowKt__ChannelsKt$emitAllImpl$12);
                ...
                try {
                    ...
                    th2 = th4;
                    r22 = r2;
                    if (!ChannelResult.m1561isClosedimpl(obj)) {
                        Throwable thM1557exceptionOrNullimpl = ChannelResult.m1557exceptionOrNullimpl(obj);
                        if (thM1557exceptionOrNullimpl == null) {
                            return Unit.INSTANCE;
                        }
                        throw thM1557exceptionOrNullimpl;
                    }
                    Object objM1559getOrThrowimpl = ChannelResult.m1559getOrThrowimpl(obj);
                    ...
                    if (r22.emit(objM1559getOrThrowimpl, flowKt__ChannelsKt$emitAllImpl$12) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    boolean z4 = z3;
                    th = th3;
