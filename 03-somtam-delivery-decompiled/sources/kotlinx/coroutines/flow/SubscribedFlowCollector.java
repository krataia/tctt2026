        ...
        try {
            switch (r2) {
                case 0:
                    ...
                    safeCollector = new SafeCollector(subscribedFlowCollector.collector, anonymousClass12.getContext());
                    Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> function2 = subscribedFlowCollector.action;
                    anonymousClass12.L$0 = subscribedFlowCollector;
                    anonymousClass12.L$1 = safeCollector;
                    anonymousClass12.label = 1;
                    if (function2.invoke(safeCollector, anonymousClass12) == coroutine_suspended) {
                    ...
                    if (r2 != 0) {
                        ...
                        if (subscribedFlowCollector2.onSubscription(anonymousClass12) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                    return Unit.INSTANCE;
                case 1:
                    safeCollector = (SafeCollector) anonymousClass12.L$1;
                    subscribedFlowCollector = (SubscribedFlowCollector) anonymousClass12.L$0;
                    ResultKt.throwOnFailure($result);
                    safeCollector.releaseIntercepted();
                    r2 = subscribedFlowCollector.collector instanceof SubscribedFlowCollector;
                    if (r2 != 0) {
