        ...
        */
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    holder = resultChannel.mo1546receiveCatchingJP2dKIU(anonymousClass2);
                    if (holder == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    latestValues2 = latestValues;
                    element = (IndexedValue) ChannelResult.m1558getOrNullimpl(holder);
                    if (element != null) {
                        return Unit.INSTANCE;
                    }
                    do {
                        ...
                        if (lastReceivedEpoch[index] != remainingAbsentValues) {
                            ...
                            element = (IndexedValue) ChannelResult.m1558getOrNullimpl(resultChannel.mo1547tryReceivePtdJZtk());
                        }
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            */
            ...
            static final class C00031<T> implements FlowCollector, SuspendFunction {
                final /* synthetic */ int $i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;
