            ...
            static final class C00041 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                */
                public final Object invokeSuspend(Object obj) throws Throwable {
                    C00041 c00041;
                    Object objMo1546receiveCatchingJP2dKIU;
                    Object obj2;
                    C00041 c000412;
                    ?? r4;
                    Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    switch (this.label) {
                        case 0:
                            ...
                            c00041 = this;
                            c00041.label = 1;
                            objMo1546receiveCatchingJP2dKIU = c00041.$second.mo1546receiveCatchingJP2dKIU(c00041);
                            if (objMo1546receiveCatchingJP2dKIU == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            FlowCollector flowCollector = c00041.$this_unsafeFlow;
                            if (!(objMo1546receiveCatchingJP2dKIU instanceof ChannelResult.Failed)) {
                                Throwable thM1557exceptionOrNullimpl = ChannelResult.m1557exceptionOrNullimpl(objMo1546receiveCatchingJP2dKIU);
                                if (thM1557exceptionOrNullimpl == null) {
                                    throw new AbortFlowException(flowCollector);
                                }
                                throw thM1557exceptionOrNullimpl;
                            }
                            Object obj3 = c00041.$this_unsafeFlow;
                            Function3 function3 = c00041.$transform;
                            Object obj4 = c00041.$value;
                            if (objMo1546receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                                objMo1546receiveCatchingJP2dKIU = null;
                            }
                            c00041.L$0 = obj3;
                            c00041.label = 2;
                            Object objInvoke = function3.invoke(obj4, objMo1546receiveCatchingJP2dKIU, c00041);
                        ...
                        case 1:
                            c00041 = this;
                            ResultKt.throwOnFailure(obj);
                            objMo1546receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
