...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM42constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM42constructorimpl = Result.m42constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m45exceptionOrNullimpl(objM42constructorimpl) == null) {
            obj2 = objM42constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM42constructorimpl2 = Result.m42constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM42constructorimpl2 = Result.m42constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m45exceptionOrNullimpl(objM42constructorimpl2) == null) {
            obj = objM42constructorimpl2;
        }
