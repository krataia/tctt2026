...
public interface ReceiveChannel<E> {
    ...
    Object mo1546receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1547tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1547tryReceivePtdJZtk = receiveChannel.mo1547tryReceivePtdJZtk();
            if (ChannelResult.m1563isSuccessimpl(objMo1547tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1559getOrThrowimpl(objMo1547tryReceivePtdJZtk);
            }
            Throwable thM1557exceptionOrNullimpl = ChannelResult.m1557exceptionOrNullimpl(objMo1547tryReceivePtdJZtk);
            if (thM1557exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1557exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass12.label) {
                case 0:
                    ...
                    objMo1546receiveCatchingJP2dKIU = receiveChannel.mo1546receiveCatchingJP2dKIU(anonymousClass12);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1546receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1558getOrNullimpl(objMo1546receiveCatchingJP2dKIU);
        }
