    ...
    public static final Object fixedPeriodTicker(long j, long initialDelayMillis, SendChannel<? super Unit> sendChannel, Continuation<? super Unit> continuation) throws Throwable {
        ...
        switch (c010012.label) {
            case 0:
                ...
                c010012.L$0 = channel;
                c010012.J$0 = delayMillis;
                c010012.J$1 = deadline3;
                c010012.label = 1;
                if (DelayKt.delay(initialDelayMillis, c010012) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                delayNs = deadline3;
                ...
                unit = Unit.INSTANCE;
                c010012.L$0 = channel;
                c010012.J$0 = deadline4;
                c010012.J$1 = delayNs2;
                c010012.label = 2;
                if (channel.send(unit, c010012) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                deadline2 = deadline4;
                deadline = delayNs2;
                ...
                if (nextDelay == 0 || deadline == 0) {
                    ...
                    c010012.L$0 = channel;
                    c010012.J$0 = deadline2;
                    c010012.J$1 = deadline;
                    c010012.label = 4;
                    if (DelayKt.delay(delayNs3, c010012) != coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    delayNs2 = deadline;
                    delayNs = deadline2;
                    ...
                    c010012.L$0 = channel;
                    c010012.J$0 = deadline6;
                    c010012.J$1 = deadline;
                    c010012.label = 3;
                    if (DelayKt.delay(jDelayNanosToMillis, c010012) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    long j2 = deadline;
                    delayNs = deadline6;
            ...
            case 1:
                delayNs = c010012.J$1;
                delayMillis = c010012.J$0;
                channel = (SendChannel) c010012.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = EventLoop_commonKt.delayToNanos(delayMillis);
                long deadline422 = delayNs + delayNs2;
                unit = Unit.INSTANCE;
                c010012.L$0 = channel;
                c010012.J$0 = deadline422;
                c010012.J$1 = delayNs2;
                c010012.label = 2;
                if (channel.send(unit, c010012) == coroutine_suspended) {
                }
                break;
            case 2:
                deadline = c010012.J$1;
                deadline2 = c010012.J$0;
                channel = (SendChannel) c010012.L$0;
                ResultKt.throwOnFailure($result);
                ...
                break;
            case 3:
                long delayNs4 = c010012.J$1;
                long deadline7 = c010012.J$0;
                channel = (SendChannel) c010012.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = delayNs4;
                delayNs = deadline7;
                ...
                break;
            case 4:
                long delayNs5 = c010012.J$1;
                long deadline8 = c010012.J$0;
                channel = (SendChannel) c010012.L$0;
                ResultKt.throwOnFailure($result);
                delayNs2 = delayNs5;
                delayNs = deadline8;
