...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1546receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        AbstractChannel$receiveCatching$1 abstractChannel$receiveCatching$1;
        Object objReceiveSuspend;
        ...
        AbstractChannel$receiveCatching$1 abstractChannel$receiveCatching$12 = abstractChannel$receiveCatching$1;
        Object $result = abstractChannel$receiveCatching$12.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch (abstractChannel$receiveCatching$12.label) {
            case 0:
                ResultKt.throwOnFailure($result);
                Object result = pollInternal();
                if (result != AbstractChannelKt.POLL_FAILED) {
                    return result instanceof Closed ? ChannelResult.INSTANCE.m1566closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1568successJP2dKIU(result);
                }
                abstractChannel$receiveCatching$12.label = 1;
                objReceiveSuspend = receiveSuspend(1, abstractChannel$receiveCatching$12);
    ...
    public final Object mo1547tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1567failurePtdJZtk() : result instanceof Closed ? ChannelResult.INSTANCE.m1566closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.INSTANCE.m1568successJP2dKIU(result);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1585constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1593remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1590plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1545onCancelIdempotentListww6eGU(list, closedForSend);
                return;
            }
        }
    }
    ...
    protected void mo1545onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) throws Throwable {
            ...
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1553boximpl(ChannelResult.INSTANCE.m1566closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
        ...
        if (receiveMode != 1) {
            ...
            Object $this$toResult$iv = ChannelResult.m1553boximpl(value instanceof Closed ? ChannelResult.INSTANCE.m1566closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.INSTANCE.m1568successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m42constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cont.resumeWith(Result.m42constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
                    ...
                    cont.resume(boolBoxBoolean, function1 == null ? null : OnUndeliveredElementKt.bindCancellationFun(function1, result, cont.getContext()));
                }
            }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1553boximpl(ChannelResult.INSTANCE.m1568successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m42constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m42constructorimpl(ChannelResult.m1553boximpl(ChannelResult.INSTANCE.m1566closedJP2dKIU(closed.closeCause))));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1553boximpl(ChannelResult.INSTANCE.m1568successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        break;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1553boximpl(ChannelResult.INSTANCE.m1566closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        break;
                }
            }
        }
