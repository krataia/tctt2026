...
public interface SendChannel<E> {
    ...
    Object mo1548trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1548trySendJP2dKIU(e);
            if (ChannelResult.m1563isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1557exceptionOrNullimpl = ChannelResult.m1557exceptionOrNullimpl(result);
