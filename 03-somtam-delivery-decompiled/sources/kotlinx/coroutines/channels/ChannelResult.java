...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m1553boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m1554constructorimpl(Object obj) {
        return obj;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1555equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).getHolder());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1556equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m1560hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public boolean equals(Object obj) {
        return m1555equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1560hashCodeimpl(this.holder);
    }
    ...
    public static final T m1559getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m1557exceptionOrNullimpl(Object arg0) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1568successJP2dKIU(E value) {
            return ChannelResult.m1554constructorimpl(value);
        }

        /* JADX INFO: renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m1567failurePtdJZtk() {
            return ChannelResult.m1554constructorimpl(ChannelResult.failed);
        }

        /* JADX INFO: renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m1566closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1554constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m1564toStringimpl(this.holder);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m1564toStringimpl(Object arg0) {
