...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00331<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00331(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00331> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00331 c00331 = new C00331(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00331.L$0 = obj;
            return c00331;
        }
        ...
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00331) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00331(sequence, defaultValue, null));
    }
    ...
    static final class C00341<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00341(Sequence<? extends T> sequence, Random random, Continuation<? super C00341> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00341 c00341 = new C00341(this.$this_shuffled, this.$random, continuation);
            c00341.L$0 = obj;
            return c00341;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00341 = this;
                    sequenceScope = (SequenceScope) c00341.L$0;
                    mutableList = SequencesKt.toMutableList(c00341.$this_shuffled);
                    break;
                case 1:
                    c00341 = this;
                    mutableList = (List) c00341.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c00341.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00341.$random.nextInt(mutableList.size());
                ...
                c00341.L$0 = sequenceScope;
                c00341.L$1 = mutableList;
                c00341.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00341) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00341(sequence, random, null));
    }
    ...
    static final class C00291<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00291(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00291> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00291 c00291 = new C00291(this.$source, this.$transform, this.$iterator, continuation);
            c00291.L$0 = obj;
            return c00291;
        }
        ...
        public final Object invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00291) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00291 = this;
                    sequenceScope = (SequenceScope) c00291.L$0;
                    i = 0;
                    it = c00291.$source.iterator();
                    break;
                case 1:
                    c00291 = this;
                    i = c00291.I$0;
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00291.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00291.L$0 = sequenceScope;
                c00291.L$1 = it;
                c00291.I$0 = i2;
                c00291.label = 1;
                if (sequenceScope.yieldAll(c00291.$iterator.invoke((C) objInvoke), c00291) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00291(source, transform, iterator, null));
    }
