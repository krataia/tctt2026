...
public final class PathTreeWalk implements Sequence<Path> {
    ...
    static final class C00271 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00271 c00271 = PathTreeWalk.this.new C00271(continuation);
            c00271.L$0 = obj;
            return c00271;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00271) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00271 = this;
                    $this$iterator = (SequenceScope) c00271.L$0;
                    ...
                    if (!Files.isDirectory(path$iv, (LinkOption[]) Arrays.copyOf(linkOptionArr3, linkOptionArr3.length))) {
                        if (Files.exists(path$iv, (LinkOption[]) Arrays.copyOf(new LinkOption[]{LinkOption.NOFOLLOW_LINKS}, 1))) {
                            c00271.L$0 = $this$iterator;
                            c00271.L$1 = stack;
                            c00271.L$2 = entriesReader;
                            c00271.label = 2;
                            if ($this$iterator.yield(path$iv, c00271) == coroutine_suspended) {
                        ...
                        if (contentIterator.hasNext()) {
                            ...
                            if (Files.isDirectory(path$iv4, (LinkOption[]) Arrays.copyOf(linkOptionArr4, linkOptionArr4.length))) {
                                ...
                                if (this_$iv5.getIncludeDirectories()) {
                                    ...
                                    c00271.L$1 = stack;
                                    c00271.L$2 = entriesReader;
                                    c00271.L$3 = pathNode2;
                                    c00271.L$4 = this_$iv5;
                                    c00271.L$5 = path$iv4;
                                    c00271.label = 3;
                                    if ($this$yieldIfNeeded$iv.yield(path$iv4, c00271) == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                ...
                case 1:
                    c00271 = this;
                    startNode3 = null;
                    path$iv2 = (Path) c00271.L$5;
                    this_$iv2 = (PathTreeWalk) c00271.L$4;
                    startNode2 = (PathNode) c00271.L$3;
                    entriesReader2 = (DirectoryEntriesReader) c00271.L$2;
                    stack2 = (ArrayDeque) c00271.L$1;
                    $this$iterator2 = (SequenceScope) c00271.L$0;
                    ResultKt.throwOnFailure($result);
                    path$iv = path$iv2;
                    entriesReader = entriesReader2;
                    this_$iv = this_$iv2;
                ...
                case 2:
                    c00271 = this;
                    entriesReader = (DirectoryEntriesReader) c00271.L$2;
                    stack = (ArrayDeque) c00271.L$1;
                    $this$iterator = (SequenceScope) c00271.L$0;
                    ResultKt.throwOnFailure($result);
                    while (!stack.isEmpty()) {
                    }
                ...
                case 3:
                    c00271 = this;
                    this_$iv3 = null;
                    path$iv3 = (Path) c00271.L$5;
                    this_$iv4 = (PathTreeWalk) c00271.L$4;
                    pathNode = (PathNode) c00271.L$3;
                    entriesReader3 = (DirectoryEntriesReader) c00271.L$2;
                    stack3 = (ArrayDeque) c00271.L$1;
                    $this$iterator3 = (SequenceScope) c00271.L$0;
                    ResultKt.throwOnFailure($result);
                    pathNode2 = pathNode;
                    $this$iterator = $this$iterator3;
                    path$iv4 = path$iv3;
    ...
    private final Iterator<Path> dfsIterator() {
        return SequencesKt.iterator(new C00271(null));
    }
