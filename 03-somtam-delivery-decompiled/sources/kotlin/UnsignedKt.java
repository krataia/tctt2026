...
public final class UnsignedKt {
    ...
    public static final int m393uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m137constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }
    ...
    public static final long m395ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m216constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        return ULong.m216constructorimpl(((long) (Long.compare(ULong.m216constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m216constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)) + quotient);
    }
    ...
    public static final long m396ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m216constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m216constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m137constructorimpl((int) v) : UInt.m137constructorimpl(UInt.m137constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m137constructorimpl(Integer.MAX_VALUE));
    }
