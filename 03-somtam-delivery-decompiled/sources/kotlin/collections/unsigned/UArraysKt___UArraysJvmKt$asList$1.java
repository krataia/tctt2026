...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UInt) {
            return m550containsWZ4Q5Ns(((UInt) element).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int index) {
        return UInt.m131boximpl(m551getpVg5ArA(index));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object element) {
        if (element instanceof UInt) {
            return m552indexOfWZ4Q5Ns(((UInt) element).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object element) {
        if (element instanceof UInt) {
            return m553lastIndexOfWZ4Q5Ns(((UInt) element).getData());
        }
        return -1;
    }
    ...
    public boolean m550containsWZ4Q5Ns(int element) {
        return UIntArray.m193containsWZ4Q5Ns(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public int m551getpVg5ArA(int index) {
        return UIntArray.m197getpVg5ArA(this.$this_asList, index);
    }

    /* JADX INFO: renamed from: indexOf-WZ4Q5Ns, reason: not valid java name */
    public int m552indexOfWZ4Q5Ns(int element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: lastIndexOf-WZ4Q5Ns, reason: not valid java name */
    public int m553lastIndexOfWZ4Q5Ns(int element) {
