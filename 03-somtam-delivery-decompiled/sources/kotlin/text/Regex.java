...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C00561(input, limit, null));
    }
    ...
    static final class C00561 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00561(CharSequence charSequence, int i, Continuation<? super C00561> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00561 c00561 = Regex.this.new C00561(this.$input, this.$limit, continuation);
            c00561.L$0 = obj;
            return c00561;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00561) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00561 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00561.L$0;
                    matcher = Regex.this.nativePattern.matcher(c00561.$input);
                    if (c00561.$limit == 1 || !matcher.find()) {
                        c00561.label = 1;
                        return $this$sequence2.yield(c00561.$input.toString(), c00561) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c00561.L$0 = $this$sequence;
                    c00561.L$1 = matcher;
                    c00561.I$0 = splitCount;
                    c00561.label = 2;
                    if ($this$sequence.yield(c00561.$input.subSequence(nextStart, matcher.start()).toString(), c00561) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00561.$limit - 1 || !matcher.find()) {
                        c00561.L$0 = null;
                        c00561.L$1 = null;
                        c00561.label = 3;
                        return $this$sequence.yield(c00561.$input.subSequence(nextStart, c00561.$input.length()).toString(), c00561) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    c00561.L$0 = $this$sequence;
                    c00561.L$1 = matcher;
                    c00561.I$0 = splitCount;
                    ...
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00561.$limit - 1) {
                    }
                    c00561.L$0 = null;
                    c00561.L$1 = null;
                    c00561.label = 3;
                    if ($this$sequence.yield(c00561.$input.subSequence(nextStart, c00561.$input.length()).toString(), c00561) == coroutine_suspended) {
                    }
                    break;
                case 1:
                    ResultKt.throwOnFailure($result);
                case 2:
                    c00561 = this;
                    splitCount = c00561.I$0;
                    matcher = (Matcher) c00561.L$1;
                    $this$sequence = (SequenceScope) c00561.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00561.$limit - 1) {
