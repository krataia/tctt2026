...
public final class UStringsKt {
    ...
    public static final String m1355toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1357toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1356toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1354toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m137constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m137constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m317boximpl(UShort.m323constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m137constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m137constructorimpl(result * uradix);
            result = UInt.m137constructorimpl(UInt.m137constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m131boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m216constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m216constructorimpl(result * uradix);
            result = ULong.m216constructorimpl(ULong.m216constructorimpl(((long) UInt.m137constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m210boximpl(result);
    }
}
