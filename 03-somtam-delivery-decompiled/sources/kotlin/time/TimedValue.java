...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1526copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1528copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1528copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1373equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1396hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1417toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1529getDurationUwyO8pc() {
        return this.duration;
    }
