...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1359minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1505minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1358elapsedNowUwyO8pc() {
        return Duration.m1403minusLRDsOJo(this.mark.mo1358elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1361plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1404plusLRDsOJo(this.adjustment, duration), null);
    }
}
