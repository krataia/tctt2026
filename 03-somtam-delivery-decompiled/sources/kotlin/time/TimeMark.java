...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1506plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* JADX INFO: renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1505minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1361plusLRDsOJo(Duration.m1421unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1401isNegativeimpl($this.mo1358elapsedNowUwyO8pc());
        }
