...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    private boolean needsMirroring() {
        return (isAutoMirrored() && DrawableCompat.getLayoutDirection(this) == 1) ? DEFAULT_DITHER : DEBUG;
    }
    ...
    static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public final int addChild(Drawable dr) {
            ...
            dr.mutate();
            dr.setVisible(DrawableContainerCompat.DEBUG, DrawableContainerCompat.DEFAULT_DITHER);
        ...
        final boolean setLayoutDirection(int layoutDirection, int currentIndex) {
            boolean changed = DrawableContainerCompat.DEBUG;
            int count = this.mNumChildren;
        ...
        public final boolean isStateful() {
            ...
            int count = this.mNumChildren;
            Drawable[] drawables = this.mDrawables;
            boolean isStateful = DrawableContainerCompat.DEBUG;
            int i = 0;
            while (true) {
                if (i >= count) {
                    break;
        ...
        public boolean canConstantState() {
            ...
            for (int i = 0; i < count; i++) {
                if (drawables[i].getConstantState() == null) {
                    this.mCanConstantState = DrawableContainerCompat.DEBUG;
                    return DrawableContainerCompat.DEBUG;
                }
            }
            this.mCanConstantState = DrawableContainerCompat.DEFAULT_DITHER;
